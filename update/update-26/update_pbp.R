...
bad_pbp <- c("b1b1def4-4bef-11f0-8dce-5f21da19a0fe", "b1c59937-4bef-11f0-9850-69185882ba54", "b20bc78d-4bef-11f0-9d84-e3ab37cba7df", 
             ...
             "b27937e8-4bef-11f0-9b65-e7c335595f42", "b28e54da-4bef-11f0-86e2-abf05c51dbb7", "e63caa04-12a9-11f1-9db3-b7438687a6df",
             "2f781bb9-18fe-11f1-be21-03773903b9b5")
...
pbp_start <- all_season |> 
  ...
  select(-jersey_number, -first_name, -last_name, -image, -contains("play_by_play_external_id"))
